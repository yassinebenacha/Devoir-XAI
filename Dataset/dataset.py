...
LABELS = {
    ...
    "fifa": [
        ...
        "On-Target","Off-Target","Blocked","Corners","Offsides","Free Kicks",
...
class Dataset:
    def __init__(self,
        ...
        # Check if file exists in root, otherwise check datasets folder
        if os.path.exists(dataset_name + ".csv"):
            self._data = pd.read_csv(dataset_name + ".csv").to_numpy()
        else:
